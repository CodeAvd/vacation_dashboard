...
export const uiCopy = {
  ru: {
    ...
    hero_badge_product: 'Vacation Cafe Simulator',
    hero_badge_mode: 'Bug-first cockpit',
    hero_badge_deploy: 'GitHub Pages static export',
    hero_eyebrow: 'Product feedback operating layer',
    hero_focus: 'Главный экран отвечает на один вопрос: что чинить и выпускать первым, чтобы не сломать cozy-ядро игры.',
    locale_switch_aria: 'Переключатель языка',
    section_anchors_aria: 'Якоря секций',
    ...
    filters_state_prefix: 'UIStateV4',
    label_theme: 'Тема',
    ...
    signals_date_range: 'Диапазон сигналов',
  ...
  en: {
    ...
    hero_badge_deploy: 'GitHub Pages static export',
    hero_eyebrow: 'Product feedback operating layer',
    hero_focus: 'The first screen answers one question: what must ship or be fixed first to protect the cozy core of the game.',
    locale_switch_aria: 'Locale switch',
    section_anchors_aria: 'Section anchors',
    ...
    signals_date_range: 'Signal range',
